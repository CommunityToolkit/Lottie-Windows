...
namespace Microsoft.Toolkit.Uwp.UI.Lottie.UIData.CodeGen.Cppwinrt
{
    ...
    sealed class CppwinrtInstantiatorGenerator : InstantiatorGeneratorBase
    {
        ...
        readonly string _cppwinrtGeneratedBaseName;
                  ...
                  stringifier)
        {
            ...
            _fileBaseName = SourceInfo.ClassName;
            _cppFileName = $"{_fileBaseName}.cpp";
            _headerFileName = $"{_fileBaseName}.h";
            _idlFileName = $"{_fileBaseName}.idl";

            _cppwinrtGeneratedBaseName = $"{SourceInfo.Namespace}.{SourceInfo.ClassName}.g";
            if (_cppwinrtGeneratedBaseName.StartsWith(configuration.RootNamespace))
            {
                // Strip off the root namespace. This is to match the file naming
                // used by cppwinrt.exe which strips the root namespace from file names.
                _cppwinrtGeneratedBaseName = _cppwinrtGeneratedBaseName.Substring(configuration.RootNamespace.Length + 1);
            }
        ...
        string GenerateHeaderText()
        {
            ...
            builder.Preamble.WriteLine($"#include \"{_cppwinrtGeneratedBaseName}.h\"");
        ...
        protected override void WriteImplementationFileStart(CodeBuilder builder)
        {
            ...
            builder.WriteLine($"#include \"{_cppwinrtGeneratedBaseName}.cpp\"");
