...
namespace Microsoft.Toolkit.Uwp.UI.Lottie.UIData.CodeGen.Cppwinrt
{
    ...
    sealed class CppwinrtInstantiatorGenerator : InstantiatorGeneratorBase
    {
                  ...
                  stringifier)
        {
            ...
            if (cppwinrtFileNameBase.StartsWith(configuration.RootNamespace))
            {
                ...
                // VS projects.
                cppwinrtFileNameBase = cppwinrtFileNameBase.Substring(configuration.RootNamespace.Length + 1);
            }
