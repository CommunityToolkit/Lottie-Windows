...
namespace Microsoft.Toolkit.Uwp.UI.Lottie.UIData.CodeGen
{
    ...
    abstract class InstantiatorGeneratorBase
    {
        ...
        protected string GenerateCode()
        {
            ...
            // This object contains information about the AnimatedVisualSourceInfo for use during codegen.
            var animatedVisualSourceInfo = new AnimatedVisualSourceInfo(
                className: _className,
                reusableExpressionAnimationFieldName: SingletonExpressionAnimationName,
                durationTicksFieldName: DurationTicksFieldName,
                compositionDeclaredSize: _compositionDeclaredSize,
                usesCanvas: _animatedVisualGenerators.Any(f => f.UsesCanvas),
                usesCanvasEffects: _animatedVisualGenerators.Any(f => f.UsesCanvasEffects),
            ...
            WriteFileStart(builder, animatedVisualSourceInfo);
            ...
            var requiredUapVersion = _animatedVisualGenerators.Select(f => f.RequiredUapVersion).Max();
            ...
            {
                animatedVisualGenerator.WriteAnimatedVisualCode(builder, animatedVisualSourceInfo);

                // TODO - this "break" is just to get compatible output during testing. Remove it to get all the versions.
                // TODO - add a WriteLine between each version (i.e. before the second one).
                break;
            }

            // Write the end of the file.
            WriteFileEnd(builder, animatedVisualSourceInfo);
        ...
        /// </summary>
        sealed class AnimatedVisualGenerator
        {
            ...
            internal void WriteAnimatedVisualCode(CodeBuilder builder, AnimatedVisualSourceInfo animatedVisualSourceInfo)
            {
                ...
                foreach (var node in _nodes)
                {
                    WriteCodeForNode(builder, animatedVisualSourceInfo, node);
                }

                // Write the end of the AnimatedVisual class.
                _owner.WriteAnimatedVisualEnd(builder, animatedVisualInfo);
            ...
            void WriteCodeForNode(CodeBuilder builder, AnimatedVisualSourceInfo info, ObjectData node)
            {
