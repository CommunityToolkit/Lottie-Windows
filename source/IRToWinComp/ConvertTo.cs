...
namespace Microsoft.Toolkit.Uwp.UI.Lottie.IRToWinComp
{
    ...
    static class ConvertTo
    {
        ...
        public static Color Color(WinCompData.Wui.Color color) =>
            IR.Color.FromArgb(color.A / 255.0, color.R / 255.0, color.G / 255.0, color.B / 255.0);
        ...
        public static Sn.Vector2 ClampedVector2(IR.Vector2 vector2) => ClampedVector2((float)vector2.X, (float)vector2.Y);
