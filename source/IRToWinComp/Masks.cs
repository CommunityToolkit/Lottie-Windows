    ...
    static class Masks
    {
        ...
        public static IEnumerable<LayerTranslator> ComposeMattedLayers(CompositionContext context, IEnumerable<(LayerTranslator translatedLayer, Layer layer)> items)
        {
            ...
            foreach (var (translatedLayer, layer) in items)
            {
                ...
                if (visual != null)
                {
                    ...
                    {
                        var compositedMatteVisual = TranslateMatteLayer(context, visual, mattedVisual, matteType == MatteType.Invert);
                        mattedVisual = null;
            ...
            CompositionContainerShape resultContainer)
        {
            ...
            foreach (var mask in masks)
            {
                ...
                // as a mask.
                maskSpriteShape.FillBrush = Brushes.CreateNonAnimatedColorBrush(context, IR.Color.Black);
