...
//       
//       Command:
//           LottieGen -Language CSharp -InputFile LottieLogo1_Modified.json
//       
//       Input file:
//           LottieLogo1_Modified.json (191317 bytes created 10:47-07:00 May 14 2020)
//       
//       Invoked on:
...
// | All CompositionObjects   |          855 |          855 |
// |--------------------------+--------------+--------------|
// | Animators                |          293 |          293 |
// | Animated brushes         |            3 |            3 |
// | Animated gradient stops  |            - |            - |
// | ExpressionAnimations     |           53 |           53 |
...
namespace AnimatedVisuals
{
    ...
    // | BackgroundColor | Color |    #FF00D1C1    |
    // | HighlightColor  | Color |    #FF007A87    |
    // | TextColor       | Color | #FFFFFFFF White |
    // ---------------------------------------------
    sealed class LottieLogo1_Modified : Microsoft.UI.Xaml.Controls.IAnimatedVisualSource
    {
        ...
        sealed class AnimatedVisual_UAPv8 : Microsoft.UI.Xaml.Controls.IAnimatedVisual
        {
            ...
            CompositionColorBrush _themeColor_HighlightColor;
            CompositionColorBrush _themeColor_TextColor;
            ...
            // - Layer aggregator
            // Offset:<187.5, 333.5>
            // Color bound to theme property value: BackgroundColor
            CompositionColorBrush ThemeColor_BackgroundColor()
            {
                var result = _c.CreateColorBrush();
                BindProperty(result, "Color", "ColorRGB(_theme.BackgroundColor.W*1,_theme.BackgroundColor.X,_theme.BackgroundColor.Y,_theme.BackgroundColor.Z)", "_theme", _themeProperties);
                return result;
            }

            // Color bound to theme property value: HighlightColor
            CompositionColorBrush ThemeColor_HighlightColor()
            {
                var result = _themeColor_HighlightColor = _c.CreateColorBrush();
                BindProperty(result, "Color", "ColorRGB(_theme.HighlightColor.W*1,_theme.HighlightColor.X,_theme.HighlightColor.Y,_theme.HighlightColor.Z)", "_theme", _themeProperties);
                return result;
            }

            // Color bound to theme property value: TextColor
            CompositionColorBrush ThemeColor_TextColor()
            {
                var result = _themeColor_TextColor = _c.CreateColorBrush();
                BindProperty(result, "Color", "ColorRGB(_theme.TextColor.W*1,_theme.TextColor.X,_theme.TextColor.Y,_theme.TextColor.Z)", "_theme", _themeProperties);
                return result;
            }
            ...
            {
                // Offset:<187.5, 333.5>
                var result = CreateSpriteShape(Rectangle_375x667(), new Matrix3x2(1F, 0F, 0F, 1F, 187.5F, 333.5F), ThemeColor_BackgroundColor());
                return result;
            }
            ...
            {
                // Offset:<196, 267>
                var result = CreateSpriteShape(Ellipse_4p6(), new Matrix3x2(1F, 0F, 0F, 1F, 196F, 267F), ThemeColor_TextColor());
                return result;
            }
            ...
            CompositionSpriteShape SpriteShape_02()
            {
                ...
                result.StrokeBrush = ThemeColor_HighlightColor();
            ...
            CompositionSpriteShape SpriteShape_03()
            {
                ...
                result.StrokeBrush = _themeColor_TextColor;
                result.StrokeDashCap = CompositionStrokeCap.Round;
                result.StrokeStartCap = CompositionStrokeCap.Round;
                result.StrokeEndCap = CompositionStrokeCap.Round;
                result.StrokeMiterLimit = 5F;
            ...
            CompositionSpriteShape SpriteShape_04()
            {
                ...
                result.StrokeBrush = _themeColor_HighlightColor;
            ...
            {
                // Offset:<196, 267>
                var result = CreateSpriteShape(Ellipse_4p7(), new Matrix3x2(1F, 0F, 0F, 1F, 196F, 267F), _themeColor_TextColor);
                return result;
            }
            ...
            {
                // Offset:<196, 267>
                var result = CreateSpriteShape(_ellipse_4p7, new Matrix3x2(1F, 0F, 0F, 1F, 196F, 267F), _themeColor_TextColor);
                return result;
            }
        ...
        sealed class AnimatedVisual_UAPv7 : Microsoft.UI.Xaml.Controls.IAnimatedVisual
        {
            ...
            {
                // Offset:<187.5, 333.5>
                var result = CreateSpriteShape(RoundedRectangle_375x667(), new Matrix3x2(1F, 0F, 0F, 1F, 187.5F, 333.5F), ThemeColor_BackgroundColor());
                return result;
            }
